...
function DruidFeral:updateAllActions()
	...
	self:updateAction(act.generators.rake, {not var.dot.rake.up or (not var.talent.bloodtalons and var.dot.rake.refreshable), var.ttk > 4})
	self:updateAction(act.generators.rake2, {var.talent.bloodtalons, var.buff.bloodtalons.up, var.dot.rake.remain < 7, var.ttk > 4})
